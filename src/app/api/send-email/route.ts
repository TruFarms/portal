  ...
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      html: `
        ...
        <p><strong>How they heard about us:</strong> ${referral || 'N/A'}</p>
        <hr>
        <h2>Message:</h2>
        <p>${message.replace(/\n/g, '<br>')}</p>
      `,
