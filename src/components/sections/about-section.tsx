...
export default function AboutSection() {
  return (
    <section id="about" className="relative min-h-[80vh] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <div className="opacity-0 animate-fade-in-down" style={{ animationDelay: '100ms' }}>
            <h2 className="text-4xl lg:text-5xl font-bold text-primary mb-6 font-headline" style={{ textShadow: '1px 1px 3px hsl(var(--background))' }}>
              About TruFarms
            </h2>
