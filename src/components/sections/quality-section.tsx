...
export default function QualitySection() {
  return (
    <section id="quality" className="py-16 lg:py-24 bg-secondary">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-8">
          {qualityAspects.map((aspect) => (
            <Card key={aspect.title} className="shadow-lg hover:shadow-xl transition-shadow duration-300">
              <CardHeader className="items-center text-center">
                <div className="p-4 bg-primary/10 text-primary rounded-full w-fit mb-3">
